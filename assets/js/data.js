...
window.PM_DATA = {
  ...
  /* Web hosting landing (see assets/js/hosting.js) ---------------------- */
  hosting: {
    ...
    types: [
      ...
      },
      {
        ...
        tagline: "A whole physical machine to yourself — for very high workloads or strict requirements.",
        rules: [
    ...
    hosts: [
      ...
      },
      {
        ...
        plans: [
          ...
          { name: "Premium", tag: "Most popular", popular: true, when: { sites: "few", skill: "beginner" }, note: "The usual sweet spot — more room, still cheap." },
      ...
      },
      {
        ...
        plans: [
          ...
          { name: "App Platform", tag: "No-server", when: { skill: "mid", use: "app" }, note: "Push code, get a managed deployment — no server admin." },
      ...
      },
      {
        ...
        plans: [
          { name: "Startup", tag: "Entry", when: { sites: "one" }, note: "The first managed plan — a single site." },
      ...
      },
      {
        ...
        plans: [
          { name: "Small (1–2 GB RAM)", tag: "Entry", when: { traffic: "low", budget: "standard" }, note: "The smallest managed server — cheap to start." },
          { name: "Standard (2–4 GB RAM)", tag: "Most popular", popular: true, when: { traffic: "medium" }, note: "The sweet spot for most growing sites." },
